...
move_action = MoveAction(cost=ds.Resources({"food":3, "water":2}))
idle_action = IdleAction(cost=ds.Resources({"food":1, "water":1}))
...
# Add agents
agent_a = ds.Agent("Agent_1", (10, 0.3), ds.Resources({"food":17, "water":20}), RoamBehavior())
agent_a.fallback_action = idle_action
env.nodes[0].add_agent(agent_a)

agent_b = ds.Agent("Agent_2", (20, 0.7), ds.Resources({"food":14, "water":9}), RoamBehavior())
