...
res = ds.Resources({"food":5, "water":10})
...
env.nodes[0].add_resources(ds.Resources({"food":3, "water":4}))
env.nodes[1].sub_resources(ds.Resources({"food":1, "water":2}))

# Define agent actions
move_action = ds.MoveAction(cost=ds.Resources({"food":3, "water":2}))
idle_action = ds.IdleAction(cost=ds.Resources({"food":1, "water":1}))
...
print(expr_a.tree)
agent_a = ds.Agent("Agent_1", expr_a, ds.Resources({"food":17, "water":20}), gp_behavior)
...
print(expr_b.tree)
agent_b = ds.Agent("Agent_2", expr_b, ds.Resources({"food":14, "water":17}), gp_behavior)
